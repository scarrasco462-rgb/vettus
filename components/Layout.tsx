    ...
    <div className="flex items-center space-x-3">
      ...
      {syncStatus !== 'synced' && (
        <button 
          ...
          }`} title={syncStatus === 'syncing' ? 'Retomando Conexão...' : 'Sinal Instável - Clique para Resetar'}>
          <div className="flex items-center space-x-2">
            {syncStatus === 'syncing' ? <RefreshCw size={14} className="animate-spin" /> : <WifiOff size={14} />}
